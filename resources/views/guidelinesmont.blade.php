...
<!-- <nav class="navbar navbar-expand-xl navbar-white bg-primary navbar-default navbar-fixed-top "> -->
...
<?php
//  print_r($email = DB::table('users')->email);
// print_r($session = DB ::table('users')->get('email'));
?>
