...
<button class=" btn btn-primary" 
    onclick="window.location.href = 'newapp'">
    Go to home
    </button>

    <button  DISABLED class="btn btn-primary"  id="btn1" value="email_id" onclick="window.location.href = 'onlinereg'">continue </button>
