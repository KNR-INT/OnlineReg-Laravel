...
<button class="btn btn-primary" style="margin-left:750px;" height="100px;" id="btn1" onclick="window.location.href = 'admitted/{id}'">
Payment</button>
...
<!-- <script>
      let class_name = document.getElementById("page_type").value;
        ...
        onclick="window.location.href = "{{ url('admitted') }}/a?class="+class_name+"&appli_id="+appli_id";
</script> -->
</body>  
</html>
<style>
