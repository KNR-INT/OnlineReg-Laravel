...
<td><input type="text" id="student_photo" name="Student_Name" value="<?php echo $student[0]->image ?>" maxlength="30"/>
</td>

</tr>
<tr>
<td><b>2. Birth Certificate</b></td>
<td><input type="text" id="student_birth_certificate"  name="Student_Name"  value="<?php echo $student[0]->birth_cer ?>" maxlength="30"/>
</td>
</tr>
<tr>
<td><b>3. Aadhar Passport</b></td>
<td><input type="text" id="student_aadhar_passport" name="Student_Name" maxlength="30"/>
</td>
</tr>
<tr>
<td><b>4. Father Aadhar</b></td>
<td><input type="text" id="student_father_aadhar" name="Student_Name" maxlength="30"/>
</td>
</tr>
<tr>
<td><b>5. Mother Aadhar</b></td>
<td><input type="text" id="student_mother_aadhar" name="Student_Name" maxlength="30"/>
</td>
</tr>
...
<td><input type="text" id="student_selected_file_name1" value="<?php echo $student[0]->image ?>" readonly></td>

</tr>
 
<tr>
<td><b>Selected File Name</b></td>
<td><input type="text" id="student_selected_file_name2" value="<?php echo $student[0]->birth_cer ?>" readonly></td>

</tr>

<tr>
<td><b>Selected File Name</b></td>
<td><input type="text" id="student_selected_file_name3" value="<?php echo $student[0]->student_adr ?>" readonly></td>

</tr>

<tr>
<td><b>Selected File Name</b></td>
<td><input type="text" id="student_selected_file_name4" value="<?php echo $student[0]->father_aadhar ?>" readonly></td>

</tr>

<tr>
<td><b>Selected File Name</b></td>
<td><input type="text" id="student_selected_file_name5" value="<?php echo $student[0]->mother_aadhar ?>" readonly></td>
</tr>
