...
<form id="myForm" action = "{{ url('store-parent') }}">
 ...
 <section class="step-wizard">
    ...
    <tbody>
      <tr>
        <td >Father Name*
         <input type="text"  class="form-control" placeholder="Enter Father name" required id="father_name" name="father_name" value="<?php if(!empty($student)){ echo $student[0]->father_name;}?>">
         <span id="father_name_err" style="color:red;"></span></td>
        <td>Mother Name*
         <input type="text"  class="form-control" placeholder="Enter Mother name" required id="mother_name" name="mother_name" value="<?php if(!empty($student)){ echo $student[0]->mother_name;}?>">
      ...
      <tr>
        <td>Mobile Number*
         <input type="text" class="form-control" placeholder="Enter Father mobile number" required id="father_mob" name="father_mob" value="<?php if(!empty($student)){ echo $student[0]->father_mob;}?>" maxlength="10"><span id="father_mob_err" style="color:red;"></span></td>
         <td>Mobile Number*
        <input type="text" class="form-control" placeholder="Enter Mother mobile number" required id="mother_mob" name="mother_mob" value="<?php if(!empty($student)){ echo $student[0]->mother_mob;}?>" maxlength="10"><span id="mother_mob_err" style="color:red;"></span></td>
      </tr>
      ...
      <tr>
        ...
        <td>Mother Email Id*
         <input type="text" class="form-control" placeholder="Enter Mother Email Id" required id="mother_email_verified_at" name="mother_email_verified_at" value="<?php if(!empty($student)){ echo $student[0]->mother_email_verified_at;}?>"><span id="mother_email_verified_at_err" style="color:red;"></span></td>
       </tr>
       ...
       <tr>
        ...
        <option disabled selected value="">--SELECT--</option>
                                <option value="Kannada"<?php if(!empty($student)){ if($student[0]->father_mother_tongue == "Kannada"){ echo "SELECTED";} } ?>>Kannada</option>
                                <option value="Tamil"<?php if(!empty($student)){ if($student[0]->father_mother_tongue == "Tamil"){ echo "SELECTED"; }} ?>>Tamil</option>
                                <option value="Telugu"<?php if(!empty($student)){ if($student[0]->father_mother_tongue == "Telugu"){ echo "SELECTED"; }} ?>>Telugu</option>
                                <option value="Hindi"<?php if(!empty($student)){ if($student[0]->father_mother_tongue == "Hindi"){ echo "SELECTED"; }} ?>>Hindi</option>
                                <option value="Others"<?php if(!empty($student)){ if($student[0]->father_mother_tongue == "Others"){ echo "SELECTED"; }} ?>>Others</option>
                ...
                <br>
                    ...
                    <option disabled selected value="">--SELECT--</option>
                             <option value="Kannada"<?php if(!empty($student)){ if($student[0]->mother_mother_tongue == "Kannada"){ echo "SELECTED"; }} ?>>Kannada</option>
                             <option value="Tamil"<?php if(!empty($student)){ if($student[0]->mother_mother_tongue == 
                             "Tamil"){ echo "SELECTED"; }} ?>>Tamil</option>
                             <option value="Telugu"<?php if(!empty($student)){ if($student[0]->mother_mother_tongue == "Telugu"){ echo "SELECTED"; } }?>>Telugu</option>
                             <option value="Hindi"<?php if(!empty($student)){ if($student[0]->mother_mother_tongue == 
                             "Hindi"){ echo "SELECTED"; }} ?>>Hindi</option>
                             <option value="Others"<?php if(!empty($student)){ if($student[0]->mother_mother_tongue == "Others"){ echo "SELECTED"; }} ?>>Others</option>
       ...
       <tr>
        <td>Residential Address*
           <input type="text" class="form-control" placeholder="Enter Residential Address" required id="father_residential_address" name="father_residential_address" value="<?php if(!empty($student)){ echo $student[0]->father_residential_address;}?>"><span id="father_residential_address_err" style="color:red;"></span></td>
        <td>Residential Address*
          <input type="text" class="form-control" placeholder="Enter Residential Address" required id="mother_residential_address" name="mother_residential_address" value="<?php if(!empty($student)){ echo $student[0]->mother_residential_address;}?>"><span id="mother_residential_address_err" style="color:red;"></span></td>
      </tr>
      <tr>
        <td>
      ...
      <tr>
        <td>Area*
            <input type="text" class="form-control" placeholder="Enter Area" required id="father_area" name="father_area" value="<?php if(!empty($student)){ echo $student[0]->father_area;}?>"><span id="father_area_err" style="color:red;"></span></td>
        <td>Area*
            <input type="text" class="form-control" placeholder="Enter Area" required id="mother_area" name="mother_area" value="<?php if(!empty($student)){ echo $student[0]->mother_area;}?>"><span id="mother_area_err" style="color:red;"></span></td>
      </tr>


       <tr>
        <td>District*
            <input type="text"  class="form-control" placeholder="Enter District" required id="father_district" name="father_district" value="<?php if(!empty($student)){ echo $student[0]->father_district;}?>"><span id="father_district_err" style="color:red;"></span></td>
        <td>District*
             <input type="text"  class="form-control" placeholder="Enter District" required id="mother_district" name="mother_district" value="<?php if(!empty($student)){ echo $student[0]->mother_district;}?>"><span id="mother_district_err" style="color:red;"></span></td>
      </tr>


        <tr>
        <td>State*
            <input type="text"  class="form-control" placeholder="Enter state" required id="father_state" name="father_state" value="<?php if(!empty($student)){ echo $student[0]->father_state;}?>"><span id="father_state_err" style="color:red;"></span></td>
        <td>State*
             <input type="text"  class="form-control" placeholder="Enter state" required id="mother_state" name="mother_state" value="<?php if(!empty($student)){ echo $student[0]->mother_state;}?>"><span id="mother_state_err" style="color:red;"></span></td>
      </tr>
       ...
       <tr>
        ...
        <br>
           ...
           <option disabled selected value="">--SELECT--</option>
                 <option value="India"<?php if(!empty($student)){ if($student[0]->father_country == 
                                "India"){ echo "SELECTED"; }} ?>>India</option>
                 <option value="America"<?php if(!empty($student)){ if($student[0]->father_country == "America"){ echo "SELECTED"; } }?>>America</option>
                <option value="Australia"<?php if(!empty($student)){ if($student[0]->father_country == "Australia"){ echo "SELECTED"; }} ?>>Australia</option>
                <option value="Brazil"<?php if(!empty($student)){ if($student[0]->father_country == "Brazil"){ echo "SELECTED"; }} ?>>Brazil</option>
                <option value="Canada"<?php if(!empty($student)){ if($student[0]->father_country == "Canada"){ echo "SELECTED"; } }?>>Canada</option>
                 <option value="Germany"<?php if(!empty($student)){ if($student[0]->father_country == "Germany"){ echo "SELECTED"; } }?>>Germany</option>
                <option value="France"<?php if(!empty($student)){ if($student[0]->father_country ==    "France"){ echo "SELECTED"; } }?>>France</option>
                 <option value="Italy"<?php if(!empty($student)){ if($student[0]->father_country ==     "Italy"){ echo "SELECTED"; }} ?>>Italy</option>
                <option value="Others"<?php if(!empty($student)){ if($student[0]->father_country == "Others"){ echo "SELECTED"; } }?>>Others</option>
                ...
                <br>
                    ...
                    <option disabled selected value="">--SELECT--</option>
                <option value="India"<?php if(!empty($student)){ if($student[0]->mother_country == "India"){   echo "SELECTED"; }} ?>>India</option>
                 <option value="America"<?php if(!empty($student)){ if($student[0]->mother_country == "America"){ echo "SELECTED"; }} ?>>America</option>
                <option value="Australia"<?php if(!empty($student)){ if($student[0]->mother_country == "Australia"){ echo "SELECTED"; }} ?>>Australia</option>
                <option value="Brazil"<?php if(!empty($student)){ if($student[0]->mother_country == "Brazil"){ echo "SELECTED"; }} ?>>Brazil</option>
                <option value="Canada"<?php if(!empty($student)){ if($student[0]->mother_country == "Canada"){ echo "SELECTED"; }}?>>Canada</option>
                <option value="Germany"<?php if(!empty($student)){ if($student[0]->mother_country == "Germany"){ echo "SELECTED"; }} ?>>Germany</option>
                <option value="France"<?php if(!empty($student)){ if($student[0]->mother_country == "France"){ echo "SELECTED"; }} ?>>France</option>
                <option value="Italy"<?php if(!empty($student)){ if($student[0]->mother_country == "Italy"){ echo "SELECTED"; }} ?>>Italy</option>
                <option value="Others"<?php if(!empty($student)){ if($student[0]->mother_country == "Others"){ echo "SELECTED"; }} ?>>Others</option>
         ...
         <tr>
        <td>Pincode*
            <input type="text" class="form-control" placeholder="Enter Pincode" required id="father_pincode" name="father_pincode" value="<?php if(!empty($student)){ echo $student[0]->father_pincode;}?>"  maxlength="8"><span id="father_pincode_err" style="color:red;"></span></td>
        <td>Pincode*
             <input type="text" class="form-control" placeholder="Enter Pincode" required id="mother_pincode" name="mother_pincode"value="<?php if(!empty($student)){ echo $student[0]->mother_pincode;}?>"  maxlength="8"><span id="mother_pincode_err" style="color:red;"></span></td>
      </tr>


       <tr>
          <td>Residential Number*
            <input type="text" class="form-control" placeholder="Enter Residential Number" required id="father_residential_no" name="father_residential_no" value="<?php if(!empty($student)){ echo $student[0]->father_residential_no;}?>" maxlength="11"><span id="father_residential_no_err" style="color:red;"></span></td>
          <td>Residential Number*
             <input type="text" class="form-control" placeholder="Enter Residential Number" required id="mother_residential_no" name="mother_residential_no" value="<?php if(!empty($student)){ echo $student[0]->mother_residential_no;}?>" maxlength="11"><span id="mother_residential_no_err" style="color:red;"></span></td>
      </tr>
       ...
       <tr class="form-group">
          ...
          <br>
            ...
            <option disabled selected value="">--SELECT--</option>
              <option value="Private Sector"<?php if(!empty($student)){ if($student[0]->father_designation == "Private Sector"){ echo "SELECTED"; }} ?>>Private Sector</option>
              <option value="Public sector"<?php if(!empty($student)){ if($student[0]->father_designation == "Public sector"){ echo "SELECTED"; } }?>>Public sector</option>
             <option value="Bussiness"<?php if(!empty($student)){ if($student[0]->father_designation == "Bussiness"){ echo "SELECTED"; }} ?>>Bussiness</option>
             <option value="Agriculture"<?php if(!empty($student)){ if($student[0]->father_designation == "Agriculture"){ echo "SELECTED"; }} ?>>Agriculture</option>
             <option value="Others"<?php if(!empty($student)){ if($student[0]->father_designation == "Others"){ echo "SELECTED"; } }?>>Others</option>
                                </select>
        ...
        <br>
             ...
             <option disabled selected value="">--SELECT--</option>
                 <option value="Private Sector"<?php if(!empty($student)){ if($student[0]->mother_designation == "Private Sector"){ echo "SELECTED"; }} ?>>Private Sector</option>
                 <option value="Public sector"<?php if(!empty($student)){ if($student[0]->mother_designation == "Public sector"){ echo "SELECTED"; } }?>>Public sector</option>
                 <option value="Bussiness"<?php if(!empty($student)){ if($student[0]->mother_designation == "Bussiness"){ echo "SELECTED"; }} ?>>Bussiness</option>
                 <option value="Agriculture"<?php if(!empty($student)){ if($student[0]->mother_designation == "Agriculture"){ echo "SELECTED"; } }?>>Agriculture</option>
                 <option value="Others"<?php if(!empty($student)){ if($student[0]->mother_designation == "Others"){ echo "SELECTED"; } }?>>Others</option>
             </select></td>
      </tr>
       ...
       <tr>
          <td>Enter Company Name*
            <input type="text" class="form-control" placeholder="Enter Company Name" required id="father_company" name="father_company" value="<?php if(!empty($student)){ echo $student[0]->father_company;}?>" ><span id="father_company_err" style="color:red;"></span></td>
        <td>Enter Company Name
             <input type="text" class="form-control" placeholder="Enter Company Name" required id="mother_company" name="mother_company" value="<?php if(!empty($student)){ echo $student[0]->mother_company;}?>" ></td>
      </tr>


       <tr>
          <td>Enter Company Address*
            <input type="text" class="form-control" placeholder="Enter Company" required id="father_company_address" name="father_company_address" value="<?php if(!empty($student)){ echo $student[0]->father_company_address;}?>" ><span id="father_company_address_err" style="color:red;"></span></td>
        <td>Enter Company Address
             <input type="text" class="form-control" placeholder="Enter Company" required id="mother_company_address" name="mother_company_address" value="<?php if(!empty($student)){ echo $student[0]->mother_company_address;}?>" ></td>
      </tr>


      <tr>
          <td>Enter Office Number*
             <input type="text" class="form-control"  placeholder="Enter Office Number" required id="father_office_number" name="father_office_number" value="<?php if(!empty($student)){ echo $student[0]->father_office_number;}?>" oninput="this.value = this.value.replace(/[^0-9.]/g,'').replace(/(\.*)\./g, '$1')" maxlength="10"><span id="father_office_number_err" style="color:red;"></span></td>
        <td>Enter Office Number
              <input type="text" class="form-control"  placeholder="Enter Office Number" required id="mother_office_number" name="mother_office_number" value="<?php if(!empty($student)){ echo $student[0]->mother_office_number;}?>" oninput="this.value = this.value.replace(/[^0-9.]/g,'').replace(/(\.*)\./g, '$1')" maxlength="10"></td>
      </tr>


      <tr>
          <td>Gross Annual Income (INR)*
             <input type="text" class="form-control"  placeholder="Enter Gross Annual Income" required id="father_annual_income" name="father_annual_income" value="<?php if(!empty($student)){ echo $student[0]->father_annual_income;}?>" oninput="this.value = this.value.replace(/[^0-9.]/g,'').replace(/(\.*)\./g, '$1')" maxlength="10"><span id="father_annual_income_err" style="color:red;"></span></td>
        <td>Gross Annual Income (INR)
              <input type="text" class="form-control"  placeholder="Enter Gross Annual Income" required id="mother_annual_income" name="mother_annual_income" value="<?php if(!empty($student)){ echo $student[0]->mother_annual_income;}?>" oninput="this.value = this.value.replace(/[^0-9.]/g,'').replace(/(\.*)\./g, '$1')" maxlength="10"></td>
      </tr>
